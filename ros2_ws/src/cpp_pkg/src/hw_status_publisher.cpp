...
#include "interfaces/msg/hardware_status.hpp"
...
public:
    ...
    {
        pub_ = this->create_publisher<interfaces::msg::HardwareStatus>(
            "hardware_status", 10);
...
private:
    ...
    {
        auto msg = interfaces::msg::HardwareStatus();
        msg.temperature = 57;
    ...
    rclcpp::Publisher<interfaces::msg::HardwareStatus>::SharedPtr pub_;
