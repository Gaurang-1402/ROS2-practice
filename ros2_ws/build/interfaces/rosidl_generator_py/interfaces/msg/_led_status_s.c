...
bool interfaces__msg__led_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interfaces.msg._led_status.LedStatus", full_classname_dest, 36) == 0);
  }
  interfaces__msg__LedStatus * ros_message = _ros_message;
  {  // led_status
    ...
    rosidl_runtime_c__String__assign(&ros_message->led_status, PyBytes_AS_STRING(encoded_field));
...
PyObject * interfaces__msg__led_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("interfaces.msg._led_status");
  ...
  {  // led_status
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->led_status.data,
      strlen(ros_message->led_status.data),
      "replace");
    if (!field) {
      return NULL;
    }
